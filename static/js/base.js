 ...
 * Copyright 2012 SuperbatTLC
 * ========================================================== */
$(".save-prefs").live('click', function(e){
    e.preventDefault()
 ...
 * Copyright 2012 SuperbatTLC
 * ========================================================== */
$(".save-ana").live('click', function(e){
    e.preventDefault()
 ...
 * Copyright 2012 SuperbatTLC
 * ========================================================== */
$(".save-user").live('click', function(e){
    e.preventDefault()
...
// SCHEDA NUOVO UTENTE
$("input[type=radio]#user-type-admin").live('change',function(){
            if($(this).is(':checked')){
...
$("input[type=radio]#user-type-op").live('change',function(){
            if($(this).is(':checked')){
                $('div#privileges').fadeIn("slow")
            }else{
                $('div#privileges').fadeOut("slow")  
